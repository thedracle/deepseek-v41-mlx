# Copied verbatim from deepseek-ai/DeepSeek-V4.1-Flash (encoding/encoding.py, MIT license): the
# prompt format and DSML tool-call parser as DeepSeek specifies them. Do not edit here.
"""
