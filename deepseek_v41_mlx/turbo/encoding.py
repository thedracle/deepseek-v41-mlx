# Copied verbatim from deepseek-ai/DeepSeek-V4.1-Flash (encoding/encoding.py, MIT license) so the
# server renders prompts and parses DSML tool calls exactly as DeepSeek specifies. Do not edit here.
"""
